...
function render(){
    ...
    let localSArray = readFromLocalS();
...
for(let i = 0 ; i <localSArray.length ; i++){
    if(localSArray[i].department == "administration"){
        admCount++;
        totalSadm = totalSadm + localSArray[i].salary1;
        }
        else if(localSArray[i].department == "marketing"){
            markCount++;
            totalSmark = totalSmark + localSArray[i].salary1;

        }else if(localSArray[i].department == "development"){
            devCount++;
            totalSdev = totalSdev + localSArray[i].salary1;

        }else if(localSArray[i].department == "finance"){
            finCount++;
            totalSfin = totalSfin + localSArray[i].salary1;
...
//let arr1=['Administration',admCount,totalSadm,avgAdm];
//print(arr1);
